drop procedure proc_manaualvaluation_v2;
...
BEGIN
    ...
    WHILE i < JSON_LENGTH(p_param) DO
        ...
        where vba_id = id;*/
		 ...
		 if actioncode = 'new' then
			-- select count(*) into l_count from cm_appln_val_bldgarea where vba_vb_id = bldgid and vba_ref = ab_bldg_no and vba_areatype_id = ab_bldgtype_id 
           --  and vba_areadesc = ab_bldgstorey_id and vba_size = ab_bldgcondn_id and vba_totsize = ab_bldgcondn_id;
           -- if l_count = 0 then

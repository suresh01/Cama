			...
			<div  id="basic-modal-content">
				<h3>Filter</h3>
				<form action="codemaintenancedetail?name={{ $name }}" id="filterForm" method="post" class="form_container">	
				@csrf		
...
<script>
	...
	function addfilter(isFirstRow){
		...
		if(isFirstRow == 1){
			$removeRow ='<div class=""> <div class="btn_24_blue"> '+
				...
				$container.append('<li class="li"><div class="form_grid_12 multiline"><div class="form_input">'+
								...
								'				<option value="LIKE">Not Equal</option>'+
								'			</select>'+
								'		</div>'+
		...
		$(".field").change(function(){
		    ...
		    var proplist = '';
			var searchid = 5;
			var termid = selectedparentvalue;

               ...
               <div class="grid_12 invoice_details">
                      <div class="invoice_tbl">
                        ...
                        <tr class=" gray_sai">
                          ...
                          <th>
                            {{__('valuation.Area_Type')}}
                          </th>
                          <th>
                            {{__('valuation.Area_Level')}}
                          </th>
                          <th>
                            {{__('valuation.Area_Category')}}
                          </th>
                          <th>
                            {{__('valuation.Area_Used')}}
                          </th>
                          <th>
                            {{__('valuation.Area')}}
                          </th>
                          <th>
                            {{__('valuation.Area_Rate')}}
                          </th>
                          <th >
                            {{__('valuation.Gross_Area_Value')}}
                          </th>
                          <th>
                            {{__('valuation.Rate')}}
                          </th>
                          <th>
                            {{__('valuation.Bldgarid')}}
                          </th>
                          <th>
                            {{__('valuation.Bldgid')}}
                          </th>
               ...
               <div class="grid_12 invoice_details">
                      <div class="invoice_tbl">
                        ...
                        <tr class=" gray_sai">
                          ...
                          <th>
                            {{__('valuation.Description')}} ({{__('valuation.Allwoance_Cateory')}} ,  {{__('valuation.Allowance_Type')}})
                          </th>
                          <th>
                            {{__('valuation.Calculation_Method')}}
                          </th>
                          <th>
                            {{__('valuation.Percentage')}} / {{__('valuation.Value')}}
                          </th>
                          <th>
                            {{__('valuation.Gross_Allowance')}}
                          </th>
                          <th>
                            {{__('valuation.allowanceid')}}
                          </th>
                          <th>
                            {{__('valuation.bldgid')}}
                          </th>
  ...
  if (window.opener.$('#deprate_{{$id}}').val()==""){
   ...
   // $('#deprate').val( window.opener.$('#deprate_{{$id}}').val());
    ...
    @foreach ($bldgar as $rec)        
      bldgardata.push( [ '{{$loop->iteration}}',  '{{$rec->artype}}','{{$rec->arcate}}','{{$rec->aruse}}','{{$rec->arlvel}}','{{$rec->aba_totsize}}','<input type="text" class="editrate" style="text-align:right;" id="rate" value="0" name="rate">','0', '','','' ] );
    @endforeach
...
function updateCalculation(){
   ...
   // var lotareatable = window.opener.$("#hiddenlandarea").DataTable();
    ...
    for (var l = 0;l < bldgdetailtable.rows().count() ;l++){
       ...
       bldgareatable.row.add([ ldata[1], ldata[2],ldata[3], ldata[4], ldata[5], ldata[8],ldata[7],ldata[9],ldata[10] ]).draw(false);   
    }

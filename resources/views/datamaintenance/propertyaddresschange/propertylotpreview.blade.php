...
<title>Paparan Kemaskini No Lot</title>
<style type="text/css">
...
@include('includes.header-popup', ['page' => 'datamaintenance'])
                    ...
                    <div class="widget_content">
						<div class=" page_content">
							<div class="invoice_container">	
								...
								<fieldset>
                                    @if($module == 'propertylotaddress')
									    <legend>Kemaskini No Lot</legend>
                                    @endif
									...
									<div style="float: right;" class="grid_6 form_container left_label">
                                        <ul>
                                            <li>
												...
												<div class="form_grid_4">
													<label class="field_title" style="width: 100%;" id="llotcodecama" for="position">Kod Lot Cama</label>
												</div>
												<div class="form_grid_8">
													{{-- <div  class="form_input"> --}}
														<input id="ilotcodecama" class="left-text" style="width: 100%;" name="ilotcodecama" type="text"  readonly="true"  />
													{{-- </div> --}}
													<span class=" label_intro"></span>
												</div>
										 		
												<div class="form_grid_4">
													<label class="field_title" style="width: 100%;" id="llotnocama" for="position">No Lot Cama</label>
												</div>
												<div class="form_grid_8">
													{{-- <div  class="form_input"> --}}
														<input id="ilotnocama" class="left-text" style="width: 100%;" name="ilotnocama" type="text"  readonly="true"  />
													{{-- </div> --}}
													<span class=" label_intro"></span>
												</div>
											
												<div class="form_grid_4">
													<label class="field_title" style="width: 100%;" id="loldlotnocama" for="position">No Lot Lama Cama</label>
												</div>
												<div class="form_grid_8">
													{{-- <div  class="form_input"> --}}
														<input id="ioldlotnocama" class="left-text" style="width: 100%;" name="ioldlotnocama" type="text"  readonly="true"  />
													{{-- </div> --}}
													<span class=" label_intro"></span>
												</div>
									...
									<div class="grid_6 form_container left_label">
										<ul>
											<li>	
												...
												<div class="form_grid_4">
													<label class="field_title" style="width: 100%;" id="llotcodemphtj" for="position">Kod Lot MPHTJ</label>
												</div>
												<div class="form_grid_8">
													{{-- <div  class="form_input"> --}}
														<input id="ilotcodemphtj" class="left-text" style="width: 100%;" name="ilotcodemphtj" type="text"  readonly="true"  />
													{{-- </div> --}}
													<span class=" label_intro"></span>
												</div>
										 		
												<div class="form_grid_4">
													<label class="field_title" style="width: 100%;" id="llotnomphtj" for="position">No Lot MPHTJ</label>
												</div>
												<div class="form_grid_8">
													{{-- <div  class="form_input"> --}}
														<input id="ilotnomphtj" class="left-text" style="width: 100%;" name="ilotnomphtj" type="text"  readonly="true"  />
													{{-- </div> --}}
													<span class=" label_intro"></span>
												</div>
											
												<div class="form_grid_4">
													<label class="field_title" style="width: 100%;" id="loldlotnomphtj" for="position">No Lot Lama MPHTJ</label>
												</div>
												<div class="form_grid_8">
													{{-- <div  class="form_input"> --}}
														<input id="ioldlotnomphtj" class="left-text" style="width: 100%;" name="ioldlotnomphtj" type="text"  readonly="true"  />
													{{-- </div> --}}
													<span class=" label_intro"></span>
												</div>
    ...
    <script>
        ...
        @foreach ($mphtj as $rec)
            ...
            $('#ilotcodemphtj').val('{{$rec->kod_lot}}');
            $('#ilotnomphtj').val('{{$rec->lotid}}');
            $('#ioldlotnomphtj').val('{{$rec->lot_lama}}');

        @endforeach

        @foreach ($lot as $rec)
            // alert('masuk');
            $('#iidcama').val('{{$rec->ma_accno}}');
            $('#ilotcodecama').val('{{$rec->lotcode}}');
            $('#ilotnocama').val('{{$rec->log_no}}');
            $('#ioldlotnocama').val('{{$rec->log_altno}}');
